...
static const char * const imx8mm_disp_axi_sels[] = {"osc_24m", "sys_pll2_1000m", "sys_pll1_800m", "sys_pll3_out",
                         "sys_pll1_40m", "audio_pll2_out", "clk_ext1", "clk_ext4", };

static const char * const imx8mm_disp_apb_sels[] = {"osc_24m", "sys_pll2_125m", "sys_pll1_800m", "sys_pll3_out",
                         "sys_pll1_40m", "audio_pll2_out", "clk_ext1", "clk_ext3", };

static const char * const imx8mm_disp_dc8000_sels[] = {"osc_24m", "dummy", "sys_pll1_800m", "sys_pll2_1000m",
                         "sys_pll1_160m", "video_pll1_out", "sys_pll3_out", "audio_pll2_out", };
static const char * const imx8mm_disp_rtrm_sels[] = {"osc_24m", "sys_pll1_800m", "sys_pll2_200m", "sys_pll2_1000m",
                         "audio_pll1_out", "video_pll1_out", "clk_ext2", "clk_ext3", };


static const char * const imx8mm_lcdif_pixel_sels[] = {"osc_24m", "video_pll1_out", "audio_pll2_out", "audio_pll1_out",
                         "sys_pll1_800m", "sys_pll2_1000m", "sys_pll3_out", "clk_ext4", };

static const char * const imx8mm_dsi_core_sels[] = {"osc_24m", "sys_pll1_266m", "sys_pll2_250m", "sys_pll1_800m",
                         "sys_pll2_1000m", "sys_pll3_out", "audio_pll2_out", "video_pll1_out", };

static const char * const imx8mm_dsi_phy_sels[] = {"osc_24m", "sys_pll2_125m", "sys_pll2_100m", "sys_pll1_800m",
                         "sys_pll2_1000m", "clk_ext2", "audio_pll2_out", "video_pll1_out", };

static const char * const imx8mm_dsi_dbi_sels[] = {"osc_24m", "sys_pll1_266m", "sys_pll2_100m", "sys_pll1_800m",
                         "sys_pll2_1000m", "sys_pll3_out", "audio_pll2_out", "video_pll1_out", };
...
static int imx8mm_clk_probe(struct udevice *dev)
{
	...
	clk_dm(IMX8MM_VIDEO_PLL1_REF_SEL,
	       imx_clk_mux(dev, "video_pll1_ref_sel", base + 0x28, 0, 2,
	...
	clk_dm(IMX8MM_VIDEO_PLL1_BYPASS,
	       imx_clk_mux_flags(dev, "video_pll1_bypass", base + 0x28, 16, 1,
	...
	clk_dm(IMX8MM_CLK_DISP_AXI,
	       imx8m_clk_composite(dev, "disp_axi", imx8mm_disp_axi_sels, base + 0x8a00));
	clk_dm(IMX8MM_CLK_DISP_APB,
	       imx8m_clk_composite(dev, "disp_apb", imx8mm_disp_apb_sels, base + 0x8a80));
	clk_dm(IMX8MM_CLK_LCDIF_PIXEL,
	       imx8m_clk_composite(dev, "lcdif_pixel", imx8mm_lcdif_pixel_sels, base + 0xa500));
	clk_dm(IMX8MM_CLK_DISP_RTRM,
	       imx8m_clk_composite(dev, "disp_rtrm", imx8mm_disp_rtrm_sels, base + 0x8b00));
	clk_dm(IMX8MM_CLK_DISP_DC8000,
	       imx8m_clk_composite(dev, "disp_dc8000", imx8mm_disp_dc8000_sels, base + 0xa280));
	clk_dm(IMX8MM_CLK_DSI_CORE,
	       imx8m_clk_composite(dev, "dsi_core", imx8mm_dsi_core_sels, base + 0xbb00));
	clk_dm(IMX8MM_CLK_DSI_PHY_REF,
	       imx8m_clk_composite(dev, "dsi_phy_ref", imx8mm_dsi_phy_sels, base + 0xbb80));
	clk_dm(IMX8MM_CLK_DSI_DBI,
	       imx8m_clk_composite(dev, "dsi_dbi", imx8mm_dsi_dbi_sels, base + 0xbc00));

	clk_dm(IMX8MM_CLK_DISP_ROOT,
	       imx_clk_gate2_shared2(dev, "disp_root_clk", "disp_dc8000", base + 0x45d0, 0, &share_count_disp));
	clk_dm(IMX8MM_CLK_DISP_AXI_ROOT,
	       imx_clk_gate2_shared2(dev, "disp_axi_root_clk", "disp_axi", base + 0x45d0, 0, &share_count_disp));
	clk_dm(IMX8MM_CLK_DISP_APB_ROOT,
	       imx_clk_gate2_shared2(dev, "disp_apb_root_clk", "disp_apb", base + 0x45d0, 0, &share_count_disp));
	clk_dm(IMX8MM_CLK_DISP_RTRM_ROOT,
	       imx_clk_gate2_shared2(dev, "disp_rtrm_root_clk", "disp_rtrm", base + 0x45d0, 0, &share_count_disp));
